...
'find_window_size.cpp' is for calculating the window size to input to slope_scanning_median.cpp. And 'find_window_size_fftw.cpp' is the accelerated version using the 'fftw3-3' library, however, this can only be used in a windows system.
